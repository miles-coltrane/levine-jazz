...
theModeA = \markup { "half-diminished (or) Locrian #2" }
theNotesA = { a'4 b' c'' d'' ef'' f'' g'' a'' }
theLyricsA = \lyricmode { "" "" "" "" "" "" "" "" }

theChordB = \chordmode { b\breve:alt }
theModeB = \markup { "altered (or) diminished whole-tone" }
