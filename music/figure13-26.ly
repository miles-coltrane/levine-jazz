...
chordsA = \chordmode {
    c1:min7 | f2:min7 e2:7.9+ | ef2:maj7 df2:7 | c2:7 gf2:7 |
    f1:min7.5- | e1:7 | ef1 |
}
trebleA = {
    <<
      { \stemUp d''4 c''4 ef''2~ | ef''2 d''2 | \tuplet 3/2 { bf'4 g'4 af'4} bf'2 | r4 g'4 af'4 bf'4 }
      \new Voice { \voiceTwo <ef' g'>1 | <ef' af'>2 <d' g'>2 | <c' f'>2 <cf' ef'>2 | <bf d'>2 <bf ef'>2 }
    >> | \break
    <<
      { bf'4 af'8 cf''8~ cf''2 | r4 d'4 d'4 d'4 | f'4 ef'4 ef'2 }
      \new Voice { \voiceTwo <cf' ef'>1 | gs1 | <g c'>1}
    >>
}
bassA = {
    <c bf>1 | f,2 <e gs>2 | <ef g>2 <df f>2 | <c e>2 <gf, ff>2 | \break
    f,1 | <e, d>1 | <ef, bf,>1 |
}

chordsBOne = \chordmode { d2:min7 df2:alt}
trebleBOne = {
    <<
...
chordsBTwo = \chordmode { e2:min7 d2:7}
trebleBTwo = {
    <<
      {af'4 gf'4 f'4 ef'4}
      \new Voice { \voiceTwo  <df' f'>2 c'2 }
    >>
}
bassBTwo = { <ef gf bf>2 <a, gf>2 }

chordsC = \chordmode {
    g1:min | a2:min7.5- d:7.9- | g1:min | c2:min7 b2:7.9+ | bf1 |
    f1:min7 d1:min7.5- df1:alt
}
trebleC = {
  <<
    {\stemUp r4 d'4 d'4 d'4 | ef'2. c'4 | ef'4 d'4 d'2~ | d'2 d'2 | r4 f'4 f'4 f'4 }
...
bassC = {
  g,1 | a,2 d,2 | g,2 <g, e> 2 | <c ef>2 <b, ds>2 | <bf, d g>1 | \break
  f,1 <d af>1 | <df f>1
}
